        ...
        Label {
            ...
            PurchaseClient {
                ...
                Component.onCompleted: {
                    client.purchaseItem({"package_name": previewData.infoMap["package_name"]});
                }

                onFailed: {
                    previewData.execute(progressBar.model[1].id, { "package_name": packageName });
                }

                onSucceeded: {
                    previewData.execute(progressBar.model[0].id, { "package_name": packageName });
                }
            }
