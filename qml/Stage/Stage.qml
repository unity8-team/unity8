...
//                property int windowedHeight
                ...
                function claimFocus() {
                    ...
                    if (root.mode == "windowed") {
                        appDelegate.restore(true /* animated */);
                    } else {
                        appDelegate.focus = true;
                    }
                }
                ...
                function maximizeTopLeft(animated) {
                    animationsEnabled = (animated === undefined) || animated;
                    windowState.state = WindowState.MaximizedTopLeft;
                }

                function maximizeTopRight(animated) {
                    animationsEnabled = (animated === undefined) || animated;
                    windowState.state = WindowState.MaximizedTopRight;
                }

                function maximizeBottomLeft(animated) {
                    animationsEnabled = (animated === undefined) || animated;
                    windowState.state = WindowState.MaximizedBottomLeft;
                }

                function maximizeBottomRight(animated) {
                    animationsEnabled = (animated === undefined) || animated;
                    windowState.state = WindowState.MaximizedBottomRight;
                }
                ...
                WindowedRightEdgeMaths {
                    ...
                    itemIndex: index
                    startWidth: windowState.geometry.width
                    startHeight: windowState.geometry.height
                    targetHeight: spreadItem.stackHeight
                    targetX: spreadMaths.targetX
                    targetY: spreadMaths.targetY
                ...
                state: {
                    ...
                    if (windowState.stateSource) {
                        ...
                        if (windowState.state === WindowState.MaximizedLeft) return "maximizedLeft";
                        if (windowState.state === WindowState.MaximizedRight) return "maximizedRight";
                        if (windowState.state === WindowState.MaximizedTopLeft) return "maximizedTopLeft";
                        if (windowState.state === WindowState.MaximizedTopRight) return "maximizedTopRight";
                        if (windowState.state === WindowState.MaximizedBottomLeft) return "maximizedBottomLeft";
                        if (windowState.state === WindowState.MaximizedBottomRight) return "maximizedBottomRight";
                        if (windowState.state === WindowState.MaximizedHorizontally) return "maximizedHorizontally";
                        if (windowState.state === WindowState.MaximizedVertically) return "maximizedVertically";
                    }
                    return "offscreen";
                }
                states: [
                    ...
                    State {
                        ...
                        PropertyChanges {
                            ...
                            x: windowState.absolutePosition.mappedX
                            y: windowState.absolutePosition.mappedY
                            width: (appContainer.width - root.leftMargin)/2
                            height: appContainer.height - panelState.panelHeight
                        }
                    },
                    State {
                    ...
                    State {
                        ...
                        PropertyChanges {
                            ...
                            y: windowState.absolutePosition.mappedY
                            width: (appContainer.width - root.leftMargin)/2
                            height: (appContainer.height - panelState.panelHeight)/2
                        }
                    },
                    State {
                    ...
                    State {
                        ...
                        PropertyChanges {
                            target: windowState.absolutePosition
                            x: root.leftMargin
                            y: (appContainer.height + PanelState.panelHeight)/2
                        }
                        PropertyChanges {
                            target: windowState.geometry
                            x: windowState.absolutePosition.mappedX
                ...
                onStateChanged: console.log("MULTIWINDOW SURFACE STATE CHANGED", screenWindow, appId, state)
