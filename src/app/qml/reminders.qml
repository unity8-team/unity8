    ...
    */
    ...
    AccountService {
        ...
        onAuthenticated: {
            ...
            // FIXME: accountService.settings['HostName'] returns null,
            // hardcoding for testing purposes for now
            EvernoteConnection.hostname = "www.evernote.com" // accountService.settings['HostName'];
